...
namespace Tallerxd.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(TallerxdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Ciudad,Capacidad")] Estadios estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Ciudad,Capacidad")] Estadios estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
